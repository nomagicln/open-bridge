...
## Plan: Remaining Test Tasks

### Completed Test Tasks
- ✅ All unit tests for core components (237 tests passing)
- ✅ Integration tests (Task 11.2) - full CLI and MCP workflow tests
- ✅ Performance tests (Tasks 13.3, 13.4, 13.5) - cold start and MCP performance
- ✅ Platform-specific keyring backend tests (Task 4.4)

### Remaining Test Tasks

The following property-based test tasks remain unfinished. These are all marked as optional (`*`) and can be implemented to provide additional correctness guarantees:

**1. Property Testing Infrastructure (Task 16)**
   - Task 16.1: Add gopter dependency and setup property test framework
   - Task 16.2: Implement property test generators (OpenAPI spec, config, parameters, request/response)
   - Task 16.3: Run all property tests with 100+ iterations

**2. Spec Parser Property Tests (Task 2)**
   - Task 2.2: Property test for OpenAPI spec round-trip parsing
   - Task 2.3: Property test for invalid spec rejection
   - Task 2.4: Property test for spec caching behavior

**3. Configuration Property Tests (Task 3)**
   - Task 3.5: Property test for config persistence round-trip
   - Task 3.6: Property test for profile export credential exclusion
   - Task 3.7: Property test for profile import validation
   - Task 3.8: Property test for config directory standards

**4. Credential Property Tests (Task 4)**
   - Task 4.3: Property test for credential keyring round-trip

**5. Semantic Mapper Property Tests (Task 5)**
   - Task 5.4: Property test for resource extraction consistency
   - Task 5.5: Property test for HTTP method to verb mapping

**6. Request Builder Property Tests (Task 7)**
   - Task 7.5: Property test for request construction from flags

**7. CLI Handler Property Tests (Task 8)**
   - Task 8.5: Property test for command to operation mapping
   - Task 8.6: Property test for output format consistency
   - Task 8.7: Property test for error message completeness
   - Task 8.8: Property test for missing parameter errors
   - Task 8.9: Property test for network error reporting

**8. MCP Handler Property Tests (Task 9)**
   - Task 9.5: Property test for MCP tool list structure
   - Task 9.6: Property test for MCP tool invocation round-trip
   - Task 9.7: Property test for MCP error handling
   - Task 9.8: Property test for AI read-only mode enforcement
   - Task 9.9: Property test for operation allowlist filtering

**9. Real-World API Testing (Task 11.3)**
   - Test with Petstore API
   - Test with GitHub API
   - Test with Stripe API
   - Verify all operations work correctly

### Steps to Complete Remaining Tests

1. **Install gopter**: Add `github.com/leanovate/gopter` to dependencies
2. **Create generators package**: Implement data generators for OpenAPI specs, configs, parameters
3. **Implement property tests**: Add property-based tests for each component following the test plan
4. **Integrate real-world APIs**: Add integration tests with actual public APIs (Petstore, GitHub, Stripe)
5. **Run full test suite**: Execute all property tests with high iteration counts (1000+)
6. **Document findings**: Record any issues discovered and verify all properties hold
